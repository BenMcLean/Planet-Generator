 ...
 *
 * Retrieved from: https://gist.github.com/KdotJPG/f4db4491b341b8987f4a
 */
...
public class OpenSimplexNoiseTileable3D {
    ...
    public OpenSimplexNoiseTileable3D(long seed, int scale) {
        this(seed, scale / 6, scale / 6, scale / 6);
    }
